...
**Lead que não fechou não morreu.**
- 1 tentativa forte (até 48h depois da reunião)
- 30 dias de follow-up ativo
- Depois → relacionamento longo (base)
- Fim de mês = última pressão suave

## BLOCO 3 — Volumetria (meta semanal)

- 10–15 follow-ups diretos
- 6–10 ligações/áudios reais
- O resto por mensagem
- Registra cada toque no pipeline (Notion: Estágio + Próximo contato)

## BLOCO 4 — Timing

- Até 48h após a reunião → **PRIORIDADE**
- 3 a 7 dias → continuidade
- 7 a 30 dias → relacionamento
- 30+ dias → base longa (nutrição)
...
## BLOCO 7 — Diagnóstico da objeção (na ligação)

```
{{nome}}, deixa eu te perguntar direto: o que te segurou pra fechar — foi o valor, o momento ou o escopo?
```
*(a resposta diz qual bloco usar abaixo)*
...
```
Mas me diz, {{nome}}…
Faz sentido voltar a olhar isso agora, ou o momento mudou de verdade?
```
...
```
Se fizer sentido, consigo te encaixar ainda essa semana.
Tenho quinta 15h ou sexta 17h. Qual fica melhor?
```

## BLOCO 12 — Follow-up nível 3 (infinito)

Regra: **sempre com horário** (nunca "me avisa quando puder").
```
{{nome}}, passando aqui — tô fechando agenda da semana.
Tenho amanhã 11h ou 15h30. Algum encaixa pra gente retomar?
```

## BLOCO 13 — Relacionamento longo
...
**Follow-up não é insistência. É consistência.**
