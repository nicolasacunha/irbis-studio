...
- **Agenda a reunião de diagnóstico** — sempre

## ⚙️ Princípios (obrigatório)

- 30% conteúdo / 70% entonação
- Ligação máxima: 10–12 minutos
...
```
Fala [Nome], tudo bem? Como cê tá?
```
*(aguarda resposta + energia alta + leve sorriso na voz)*
...
```
Só pra eu entender se faz sentido agora: é um momento de investir pra crescer, ou tá mais pra organizar a casa?
...
### 9. Validação
```
Perfeito, [Nome]. Pelo que você me falou, faz total sentido a gente olhar isso com calma.
```
...
Não mando proposta solta — a gente conversa e você vê tudo com clareza.
```

### 11. Fechamento do agendamento
```
...
```
Fechado, [Nome]. É uma conversa direta e sem compromisso — mas o ideal é você estar sem correria pra aproveitar de verdade.
Combinado?
```
...
## 📊 Registrar no pipeline (Notion)

A cada ligação, atualiza o card / conta:
