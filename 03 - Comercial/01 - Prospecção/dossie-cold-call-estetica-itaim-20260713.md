# Dossiê de cold call — Estética premium Itaim Bibi (13/jul/2026)

Fonte dos leads: 3 CSVs raspados do Google Maps na raiz do repo (15/jun) — `resultado teste - phantom.csv`, `resultado real.csv`, `result vertical.csv`. 30 negócios únicos; este dossiê recorta o segmento **estética premium no Itaim Bibi** (Frente A do método de prospecção).

Diagnóstico de site feito por leitura automática em 13/jul. Marcação de confiança: `[Confirmado]` (li/verifiquei), `[Provável]` (sinal forte, confirmar na hora), `[Não verificado]`.

**Guardrails aplicados** (skill `irbis-prospeccao-e-diagnostico`):
- Objetivo da ligação: **reunião agendada**. Nunca preço no telefone (nasce na reunião).
- Prova social: só **"+R$350k" (E-Force)**. Proibido "+500" e "LTV 1,8x".
- Ligação fria: 10–12 min, 2–3 horários concretos, nunca "pode?".
- As ABERTURAS abaixo dão a estrutura + o gancho de dor. **Revisar a voz final com `irbis-brand-voice`** antes de usar (assina "Nicolas", sem travessão, sem jargão de agência).

---

## Triagem — quem fica FORA

| Negócio | Motivo (Tabela NÃO LIGAR) |
|---|---|
| Onodera Estética | Rede/franquia (`onodera.com.br/unidades/…`) — decisão de site centralizada |
| Giolaser Itaim | Rede/franquia (`giolaser.com.br/itaim-bibi`) — idem |
| Agências de marketing (SD Marketing, Nume, Axei, OTT, Inpyx… — 10 no CSV) | São do ramo digital, têm site próprio e fazem sites — não são cliente |
| Empresas de software (Numen IT, Bravo, 4yousee… — 10 no CSV) | Fora do ICP de "negócio local premium"; software house tem site. Deixar para uma leva B2B separada, se o dono quiser |

---

## Fila priorizada (ligar de cima para baixo)

| # | Negócio | Reviews | Sinal de gargalo | Tier |
|---|---|---|---|---|
| 1 | Life Itaim | 196 ⭐5,0 | Sem site próprio (só Instagram) | 1 |
| 2 | Pró Estética | 1235 ⭐4,8 | Botões "Agendar" quebrados (`#!`) | 1 |
| 3 | Giselle Chaves | 88 ⭐5,0 | Sem site | 1 |
| 4 | Dra. Mafê Porfirio | 32 ⭐5,0 | Site é Google Sites (amador p/ injetáveis) | 1 |
| 5 | Bella Corpo | 200 ⭐5,0 | Site ok, sem agendamento (só WhatsApp) | 2 |
| 6 | Juliestetik | 247 ⭐5,0 | Site ok, sem agendamento | 2 |
| 7 | Sheila Duarte | 104 ⭐5,0 | Site ok, sem formulário/telefone alternativo | 2 |
| 8 | Instituto Mônica Silva | 6 ⭐5,0 | Sem site (só Instagram), mas GMB fraco | 3 |

Guard-rail SAM ≥R$8k: estética premium no Itaim tem ticket compatível (procedimentos de R$1k–15k). Os Tier 1 justificam a âncora na reunião; nos Tier 2/3 espere objeção de preço mais cedo.

---

## Fichas

### 1. Life Itaim — Clínica de Estética, Harmonização Facial e Emagrecimento · **Tier 1**
...
## Próximos passos sugeridos (para o Nicolas decidir)
1. Confirmar "sem site" na hora para Life Itaim, Giselle, Instituto Mônica (buscar o nome no Google antes de afirmar — "sem site no Maps engana").
2. Ligar na ordem da fila; registrar cada ligação no pipeline do Notion (feitas / atendidas / passou da recepção / falou com decisor / reunião agendada).
3. Rodar as ABERTURAS por `irbis-brand-voice` antes de usar.
4. Meta da semana (plano JDP): ≥1 reunião agendada que não veio de indicação.
