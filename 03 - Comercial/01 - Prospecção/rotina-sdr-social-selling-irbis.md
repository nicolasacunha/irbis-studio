...
Iniciar conversas nas redes (principalmente Instagram) com:
- Novos seguidores (o conteúdo do Dia 4 traz eles)
- Quem engajou (curtiu, comentou, viu story)
- Contatos antigos parados

**Objetivo único: gerar reunião de diagnóstico.**
...
8. **Tripé do relacionamento** — ponto em comum + apreciação + interesse genuíno.

## O que é social selling (venda invisível)

Criar um canal que conduz o lead do ponto A ao B por interações — muitas vezes sem parecer venda.
- A conversa conduz, não empurra
- Cada interação é oportunidade
- Toda conversa bem feita avança o lead
...
Move o card conforme avança:
`A contatar → Contatado → Respondeu → Conversa fluiu → Reunião agendada`
Origem = **Social selling**. Atualiza no fim de cada bloco.

## Follow-up (níveis)

1. Tentativa inicial · 2. Interesse leve · 3. Quase convertido · 4. No-show · 5. Pós-reunião · 6. Longo prazo
Detalhe de cada um no **Manual de Follow-up**. Regra: quem não responde hoje pode fechar amanhã.

## Ferramentas (IRBIS)

- **Notion** — pipeline
- **Instagram + WhatsApp** — canal
- **Phantom Buster** — lista
- **Canva** — deck/prova
