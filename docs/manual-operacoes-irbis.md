...
| Planos de recorrência (2 pacotes) | `03 - Comercial/04 - Entrega e Recorrência/planos-recorrencia-irbis.md` | ✅ Reescrito 09/ago/2026, mensalidade atualizada em 12/ago — recorrência confirmada só pro Bot de IA (R$1.000 de setup + mensalidade de R$500 a R$3.000, faixa fechada na reunião); Sistemas e Consultoria sem recorrência confirmada |
