...
O [Adash](https://irbis.com.br/adash) foi desenvolvido pela IRBIS para reunir mídia, CRM, conteúdo, relatórios e agente de IA na operação da QG Group. Ele é uma evidência de que a IRBIS entregou uma estrutura compatível com uma operação de agência e com a necessidade de conectar contexto entre frentes.
...
Não. O Adash comprova uma entrega da IRBIS para a QG Group, com mídia, CRM, conteúdo, relatórios e agente de IA reunidos na operação. Não há resultado financeiro público medido.
