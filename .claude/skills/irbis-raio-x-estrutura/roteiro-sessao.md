...
**Quando o dono não sabe:** não insista e não invente. Pergunte a faixa direto: "de leve,
isso é menos de 1 hora, entre 1 e 5, ou mais de 5 por semana?" Registre a resposta como
`<1h`, `1-5h` ou `>5h`, marque `(estimado)`, e o job fica fora da conta final.
