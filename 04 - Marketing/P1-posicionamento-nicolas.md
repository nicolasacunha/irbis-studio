# P1 — Posicionamento Central e Reforma de Perfil
...
## ⚡ PIVOT DE FOCO — sistema com IA, 28/jul/2026 (palavra do dono)

**Muda o centro do posicionamento: não mais "site", agora "sistema com IA".** Declarado pelo Nicolas em 28/jul/2026, direto no chat: atualizar a rotina de roteiros pra realidade da empresa hoje, que não é mais sites, é IA. Base: `docs/visao-irbis.md` (aprovada 21/jul) — "Empresas da economia real pagam caro por aquilo que trabalha dentro delas. Site é a porta; sistema com IA é o que mora dentro."

- Toda a Parte 1 (Big Idea, Vilão, Arco, Filtro) ganha uma versão **v3**, abaixo de cada v2 correspondente. v2 fica marcada histórico, não apagada.
- Bio (item 5) e Pilares de Conteúdo (item 9) idem, versão v3.
- **Site não sai do posicionamento — vira porta/upsell, não mais o produto central.** Isso é coerente com `CLAUDE.md`: sites seguem escopo válido (Camada 1), sistema com IA é a Camada 2 que passa a liderar o discurso.
...
**Lógica água-diamante (Adam Smith), transposta pra sistema:** automação de prateleira virou água (qualquer ferramenta promete resolver, qualquer curso ensina a plugar um Zapier). Sistema pensado pra operação real de um negócio específico é o diamante. Eu entrego o diamante, não a ferramenta genérica.

**Vilão do posicionamento (duas caras, v3):**
1. A **IA de prateleira**: chatbot genérico, automação pronta que promete resolver e não entende a operação real do cliente. É a nova cara do commodity, agora em cima de sistema em vez de site.
2. A **operação manual aceita como normal**: o próprio dono que segue rodando tudo na planilha, no WhatsApp, na memória de alguém, porque "sempre foi assim" e nunca parou pra sistematizar.
...
- Discutível? Sim, por dois flancos opostos: quem acha que "plugar uma IA" já resolve, e quem acha que sistema sob medida é coisa de empresa grande.
- Tem vilão claro? Sim, as duas caras seguem: a IA de prateleira e a operação manual normalizada.
- Cabe em 15 segundos? As 3 versões cabem.

**Guarda-corpo da v3 (crítico, revisar quando o 1º case de IA fechar):** ainda não existe sistema de IA entregue e medido. "Que devolve hora pro dono" é promessa da tese, não resultado citável ainda. Em peça de venda ou conteúdo, a única prova numérica é +R$350k (E-Force, site), usada como prova do MÉTODO, nunca como se fosse resultado de um sistema de IA.

**Tese v2 (histórico, 15/jul/2026, substituída em 28/jul/2026):**
...
Vilão v2: (1) a IA preguiçosa — site-commodity gerado em minutos; (2) a agência — cobra preço de diamante por execução que virou água.
...
### 2. Arco de 3 Atos ✅ FECHADO — v3 em 28/jul/2026, substitui v2

Chave do arco v3: o "Antes" do Nicolas e a crença do mercado hoje são a MESMA mentira em dois formatos. Ele achava que o trabalho terminava quando o site ia ao ar (a entrega era o fim). O mercado acha que plugar uma IA resolve o negócio (a ferramenta é o fim). Os dois atribuem o resultado a um evento pontual, não a uma operação contínua.

**Ato 1 (Antes):** Quando comecei, achava que meu trabalho terminava quando o site ia ao ar. Site publicado, cliente satisfeito, ponto final. Eu tratava a entrega como o fim, não como o começo de alguma coisa maior.

**Ato 2 (Virada):** A virada veio com a E-Force: o que fez aquele site gerar mais de R$350 mil em vendas não foi só a página bonita no ar, foi o critério por trás de cada decisão. Entendi que essa lógica não serve só pra site. Ela serve pra qualquer sistema que fica rodando dentro do negócio do cliente.

**Ato 3 (Missão):** Hoje toda empresa da economia real ouve falar de IA e pensa em chatbot ou automação de prateleira. Não consigo ficar calado vendo dono de negócio pagando caro, em tempo e retrabalho, por uma operação que continua manual quando existe um jeito de colocar IA de verdade dentro dela, decidida por quem entende do negócio.
...
**Nota de prova (v3, atualizada 28/jul):** o Ato 2 usa a E-Force (site) como prova do MÉTODO, não como sistema de IA entregue — o 1º case de sistema (A. Cunha ADV) fechou hoje mas ainda não foi entregue nem medido. Não estender "R$350k" como se fosse resultado de automação/IA.

**Arco v2 (histórico, 15/jul/2026, substituído em 28/jul/2026):** Antes: "saía tudo feio e genérico com IA, achava que nunca ia conseguir fazer site bom assim." · Virada: "E-Force — coloquei identidade, estratégia e critério na frente da máquina, saiu um site que gerou +R$350k." · Missão: "internet inundada de site-commodity; com pensamento humano na frente, a IA entrega site com identidade."
...
**✅ Parte 1 (A Fundação) fechada:** Tese, Vilão de duas caras, Arco de 3 Atos e Filtro Diário definidos.

## Parte 2 — Reforma de Perfil ✅ FECHADA

### 4. Foto de perfil ✅ FECHADO
Foto atual: rosto centralizado, fundo claro, camisa preta.
- Qualidade técnica: boa. Luz, foco e resolução ok.
- Rosto: bem visível e legível na miniatura.
- Contraste: fundo claro com cabelo e camisa escuros dá bom recorte no círculo.
- Coerência com a tese: passa limpeza e profissionalismo. É um pouco neutra (cara de foto 3x4), mas funciona.
...
### 6. Posts Fixados ✅ FECHADO (estrutura) — re-ancorados na tese v3 em 28/jul/2026
...
- **Nomes:** "Me" é vago, dá pra trocar por "Quem sou" ou "Bastidor". O resto ok.
...
**✅ P1 COMPLETO.** Fundação, Reforma de Perfil e Direção documentados.
...
## Próximos passos (aplicar no perfil)
Documentação 100% pronta. O que falta é aplicação manual no Instagram:
